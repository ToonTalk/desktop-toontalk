Release notes for ToonTalk(TM) beta release 6B.  February 21, 1997.
...
The beta software will refuse to run on May 1.  Warnings will begin
to appear on April 15. If you provide, or have provided, any feedback you
will be entitled to a new improved beta version.  All software is provided
as is and no one is liable for any bugs.
...
If you are installing from files obtained over the internet then unzip
ttbeta6a.exe in a temporary directory and copy all the other files to
that directory. Install it by running <temp directory>\setup.  You can
...
http://www.toontalk.com/narrate.htm for details.
...
- Martian that talks (uses audio rather than talk balloons).
- much faster robots when off screen.
- better audio.
- joystick support.
- allow robots to work on things other than boxes.
- ToonTalk to Java translator.
...
ttbeta6a.exe -- system executable
starttt.exe -- Convienent way of starting ToonTalk and its demos
m22.bt6 -- images at 320x240 resolution
resind.bt6 -- sounds and other data
...
m25.nda -- high resolution (640x480) data.  
ttbug16.exe -- debugging version of 16 bit beta release
*.spk -- narration files for every dmo file.

toontalk.doc -- A paper about ToonTalk in Microsoft Word for Windows format
metaphor.doc -- A paper about the use of metaphor in ToonTalk in Word format
vl96.doc -- A recently written paper about systolic programming in ToonTalk.
...
32 bit version of ToonTalk.
It requires Microsoft's DirectPlay and DirectSound extensions to Windows
95 and Windows NT 4.0.  Contact KenKahn@ToonTalk.com if you wish to beta
test this.
