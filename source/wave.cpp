        ...
        )
{
    ...
    for (cT = 0; cT < cbDataIn; cT++)
        ...
        // Actual copy.
        *((BYTE*)pbDest+cT) = (*((BYTE*)mmioinfoIn.pchNext++));    // paren was in wrong place prior to 211102 (since becoming C++)                                                    
        }
        ...
        )
{
    ...
    *cbActualWrite = 0;
    ...
    for (cT=0; cT < cbWrite; cT++)
        ...
        // *((BYTE*)pmmioinfoOut->pchNext)++ = *((BYTE*)pbSrc+cT); // was
        (*((BYTE*)pmmioinfoOut->pchNext++)) = *((BYTE*)pbSrc+cT);
//        (*((BYTE*)pmmioinfoOut->pchNext++)); // moved paren on 211102
        (*cbActualWrite)++;
        }
