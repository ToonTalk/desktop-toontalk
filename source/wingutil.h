...
void bytes_from_RLE8_and_permute(BYTE FAR *pb, DWORD width, int pitch, BYTE FAR *expansion, unsigned char *permutation);
...
PDIB        DibReadBitmapInfo(HANDLE fh); // (HFILE fh);
PDIB DibReadBitmapInfoFromFileName(LPSTR szFile); // Ken Kahn's addition
