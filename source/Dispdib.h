...
// added by Ken Kahn -- seems to be missing (in Borland C++ 4.53 at least)
...
// Ken Kahn's addition -- used to be more...
...
#define DISPLAYDIB_WINDOW_CLASS     _T("DisplayDibWindow")
...
//#else
// Ken kahn commented this out and calls it elsewhere
//	 if ((UINT) LoadLibrary(DISPLAYDIB_DLL) < (UINT)HINSTANCE_ERROR)
//		  return NULL;    // loading DISPDIB did not work
//#endif

    return CreateWindowG(DISPLAYDIB_WINDOW_CLASS,"",dwStyle,0, 0,
            GetSystemMetrics(SM_CXSCREEN),GetSystemMetrics(SM_CYSCREEN),
            hwndParent, NULL,
//  GetWindowInstance isn't defined -- changed by Ken Kahn
